...
@Validated
@Configuration
@ConfigurationProperties(prefix = Constants.PROJECT + ".web")
public class WebProperties {
     ...
     *
     * @see WebAutoConfigure#configurePathMatch(PathMatchConfigurer)
     */
     ...
     * <p>
     * 因为我们有多个 modules 包里会包含 Controller，所以只需要写到 com.ocean 这样的层级
     */
