package com.ocean.framework.core.enums;
...
public enum Deleted {
    ...
    public static Deleted getByValue(Integer value) {
        ...
        throw new ParameterException(String.format(Constants.INVALID_ENUM_VALUE_MESSAGE, Deleted.class.getSimpleName(), value));
    }
}
