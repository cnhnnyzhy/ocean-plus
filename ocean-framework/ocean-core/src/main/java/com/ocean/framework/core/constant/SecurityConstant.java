package com.ocean.framework.core.constant;
...
public interface SecurityConstant {
     ...
     * 用户CH信息头 用户的类型
     */
    String USER_CH_HEADER = "x-userch-header";
     ...
     */
    String CACHE_CLIENT_KEY = "oauth:client:details";
    /**
     * OAUTH模式登录处理地址
     */
     ...
     * 令牌颁发者
     */
    String ISS = "https://sso.vhall.com";
